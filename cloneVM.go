...
var (
	...
	pePass        string = "Nutanix/4u"                                                            // PE Password
	peIp          string = "10.1.1.1:9440"                                                         // PE Cluster VIP
	peUrl         string = "/PrismGateway/services/rest/v2.0/"                                     // URL for v2 API
	vmName        string = "Move-VM-Aditya"                                                        // VM to be cloned
	cloneNameList        = []string{"Move-Aditya-Test4", "Move-Aditya-test5", "Move-Aditya-Test6"} // Clone Names
       ...
       [
         {
          ...
          "vm_nics":
           [
            {
             "network_uuid":"8e1a8980-f014-46c4-b32c-5e1187a1fe75"
            }
           ],
